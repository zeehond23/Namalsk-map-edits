...
dayZ_serverName = "ZD"; //Shown to all players in the bottom left of the screen (country code + server number)
...
//Temp settings
dayz_DamageMultiplier = 20; //1 - 0 = Disabled, anything over 1 will multiply damage. Damage Multiplier for Zombies.
...
call compile preprocessFileLineNumbers "namalsk\init\compiles.sqf";
